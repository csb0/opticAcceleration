function [Dx Dy D cout] = estimateOpticFlow2D(ImgSeq, opt)
% estimateOpticFlow2D
...
%   cout    - Confidence in flow estimates
%
% DESCRIPTION
...
% CSB, sept 11, 2020
% compute confidence map output "cout"
% copied in from Farneback's original implementation in the "spatial domain
% toolbox
